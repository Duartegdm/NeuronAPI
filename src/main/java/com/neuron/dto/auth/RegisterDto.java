...
public class RegisterDto {
    ...
    public void setEmail(@NotBlank(message = "O e-mail é obrigatório") @Email(message = "O e-mail deve ser válido") @Size(max = 150, message = "Limite de caracteres excedido") String email) {
        this.email = email;
    }
