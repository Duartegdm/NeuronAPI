...
public class CreateUsuarioDto {
    ...
    @UniqueElements(message = "Esse e-mail já está em uso")
    ...
    public @NotBlank(message = "O e-mail é obrigatório") @UniqueElements(message = "Esse e-mail já está em uso") @Email(message = "O e-mail deve ser válido") @Size(max = 150, message = "Limite de caracteres excedido") String getEmail() {
        return email;
    }
    ...
    public void setCodigoAcesso(@NotBlank(message = "O tipo de acesso é obrigatório") int codigoAcesso) {
